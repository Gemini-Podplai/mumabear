...
"""
🔗 Pipedream Fallback Service - Pattern-based workflow creation
                ...
                'template': {
                    ...
                    'steps': [{
                        ...
                        'config': {
                            ...
                            'message': '🌟 GitHub Event: {{event.type}} in {{repository.name}}'
                        }
                    }],
                    'category': 'DevOps',
            ...
            'github_star': {
                ...
                'template': {
                    ...
                    'steps': [{
                        ...
                        'config': {
                            'channel': '#general',
                            'message': '🌟 {{sender.login}} starred {{repository.name}}!'
                        }
                    }],
                ...
                'template': {
                    ...
                    'steps': [{
                        ...
                        'config': {
                            ...
                            'message': '📧 New email: {{subject}} from {{sender}}'
                        }
                    }],
    ...
    def create_workflow_from_patterns(self, request: str, user_id: str = None) -> Dict[str, Any]:
        ...
        try:
            ...
            if matched_patterns:
                ...
                logger.info(f"✅ Matched pattern '{pattern_name}' with score {score}")
