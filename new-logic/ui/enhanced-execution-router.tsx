            ...
            <div className="lg:col-span-2">
              <div className={`p-4 rounded-xl ${
                ...
                <label className={`block text-sm font-medium mb-2 ${
                  theme === 'custom' ? 'text-gray-300' : 'text-gray-700'
                }`}>
                  Task Description
                </label>
                <textarea
                  ...
                  rows={4}
                  className={`w-full px-4 py-3 rounded-lg border resize-none focus:ring-2 focus:ring-orange-500 focus:border-transparent ${
                    theme === 'custom'
                  ...
                  <div className="flex items-center justify-between mb-3">
                    <div className="flex items-center space-x-3">
                      <platform.icon className={`w-6 h-6 ${
                        platform.type === 'e2b' ? 'text-blue-500' :
                  ...
                  <div className="grid grid-cols-4 gap-4 text-center">
                    ...
                    <div>
                      <div className={`text-2xl font-bold ${
                        activeWorkflow.complexity.level === 'simple' ? 'text-green-500' :
                    ...
                    >
                      ...
                      {step.output && (
                        <div className={`mt-3 p-3 rounded-lg ${
                          theme === 'custom' ? 'bg-gray-900' : 'bg-gray-50'
                        }`}>
                ...
                >
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <div className={`w-2 h-2 rounded-full ${
                      platform.status === 'available' ? 'bg-green-400' :
