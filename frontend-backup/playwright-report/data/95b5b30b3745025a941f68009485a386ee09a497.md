...
- Name: Enhanced Theme System >> should handle animated background interactions
- Location: /home/woody/CascadeProjects/podplay-scout-alpha/frontend/tests/e2e/enhanced-theme.spec.ts:242:3
...
Locator: locator('[data-testid="animated-background"]')
Expected: visible
Received: hidden
Call log:
  - expect.toBeVisible with timeout 10000ms
  - waiting for locator('[data-testid="animated-background"]')
    13 × locator resolved to <div data-testid="animated-background" class="relative w-full h-full absolute inset-0 z-0">…</div>
       - unexpected value "hidden"

    at /home/woody/CascadeProjects/podplay-scout-alpha/frontend/tests/e2e/enhanced-theme.spec.ts:245:38
```
